...
namespace Lab4 {
    ...
    public partial class Lab4DataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(int maNhanVien, string hoTen, string diaChi, string soDT, PhongBanRow parentPhongBanRowByFK_NhanVien_PhongBan) {
                ...
                if ((parentPhongBanRowByFK_NhanVien_PhongBan != null)) {
                    columnValuesArray[4] = parentPhongBanRowByFK_NhanVien_PhongBan[0];
                }
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NhanVien] WHERE (([maNhanVien] = @Original_maNhanVien) AND ([h" +
                "oTen] = @Original_hoTen) AND ([diaChi] = @Original_diaChi) AND ([soDT] = @Origin" +
                "al_soDT) AND ([maPhongBan] = @Original_maPhongBan))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [maNhanVien] = @maNhanVien, [hoTen] = @hoTen, [diaChi] = @diaChi, [soDT] = @soDT, [maPhongBan] = @maPhongBan WHERE (([maNhanVien] = @Original_maNhanVien) AND ([hoTen] = @Original_hoTen) AND ([diaChi] = @Original_diaChi) AND ([soDT] = @Original_soDT) AND ([maPhongBan] = @Original_maPhongBan));
SELECT maNhanVien, hoTen, diaChi, soDT, maPhongBan FROM NhanVien WHERE (maNhanVien = @maNhanVien)";
        ...
        public virtual int Fill(Lab4DataSet.NhanVienDataTable dataTable) {
        ...
        public virtual Lab4DataSet.NhanVienDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Lab4DataSet.NhanVienDataTable dataTable = new Lab4DataSet.NhanVienDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Lab4DataSet.NhanVienDataTable dataTable) {
        ...
        public virtual int Delete(int Original_maNhanVien, string Original_hoTen, string Original_diaChi, string Original_soDT, int Original_maPhongBan) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_maPhongBan));
        ...
        public virtual int Insert(int maNhanVien, string hoTen, string diaChi, string soDT, int maPhongBan) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(maPhongBan));
        ...
        public virtual int Update(int maNhanVien, string hoTen, string diaChi, string soDT, int maPhongBan, int Original_maNhanVien, string Original_hoTen, string Original_diaChi, string Original_soDT, int Original_maPhongBan) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_maPhongBan));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string hoTen, string diaChi, string soDT, int maPhongBan, int Original_maNhanVien, string Original_hoTen, string Original_diaChi, string Original_soDT, int Original_maPhongBan) {
    ...
    public partial class PhongBanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PhongBan] WHERE (([maPhongBan] = @Original_maPhongBan) AND ([s" +
                "oDT] = @Original_soDT) AND ([diaDiem] = @Original_diaDiem))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_maPhongBan", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "maPhongBan", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_soDT", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "soDT", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PhongBan] SET [maPhongBan] = @maPhongBan, [soDT] = @soDT, [diaDiem] = @diaDiem WHERE (([maPhongBan] = @Original_maPhongBan) AND ([soDT] = @Original_soDT) AND ([diaDiem] = @Original_diaDiem));
SELECT maPhongBan, soDT, diaDiem FROM PhongBan WHERE (maPhongBan = @maPhongBan)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Lab4DataSet.PhongBanDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Lab4DataSet.PhongBanDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Lab4DataSet.PhongBanDataTable dataTable = new Lab4DataSet.PhongBanDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Lab4DataSet.PhongBanDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Delete(int Original_maPhongBan, string Original_soDT, string Original_diaDiem) {
            ...
            if ((Original_soDT == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_soDT));
            }
        ...
        public virtual int Update(int maPhongBan, string soDT, string diaDiem, int Original_maPhongBan, string Original_soDT, string Original_diaDiem) {
            ...
            if ((Original_diaDiem == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_diaDiem));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
